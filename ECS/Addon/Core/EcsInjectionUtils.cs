...
namespace GrozaGames.Kit.ECS
{
    public static class EcsInjectionUtils
    {
        ...
        public static void InjectEcs(object target, EcsWorld world)
        {
            if (world == null)
        ...
        private static void Inject(object target, object injectedObject, Type injectionType)
        {
        ...
        private static void InjectPools(object target, EcsWorld world)
        {
            if (world == null)
        ...
        private static void InjectQueries(object target, EcsWorld world)
        {
            if (world == null)
